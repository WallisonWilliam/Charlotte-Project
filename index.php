      ...
      <div class="parentLoginDiv">
        ...
        <div class="loginUserInputArea">
          <form method="post" class="loginForm">
            ...
            <input type="text" name="usuario" id="username" placeholder="Insira seu nome de usuário..."
              class="inputBox" />
            <div class="passwordInput>">
              <h3 class="inputText">Senha</h3>
            </div>
            <input type="password" name="senha" id="password" placeholder="Insira sua senha..." class="inputBox" />
          ...
          function realizarLogin()
          {
            ...
            echo "<b><font color=\"red\"> $situacao </font></b>";
          }
